...
const BASE = "https://github.com/oalexandre/ilumi/releases/download/v0.1.2";
const RELEASES = "https://github.com/oalexandre/ilumi/releases";

const platforms: { os: OS; label: string; file: string; detail: string }[] = [
  { os: "mac", label: "macOS", file: "Ilumi-0.1.2-arm64.dmg", detail: "Apple Silicon (.dmg)" },
  { os: "mac", label: "macOS Intel", file: "Ilumi-0.1.2-x64.dmg", detail: "Intel (.dmg)" },
  { os: "windows", label: "Windows", file: "Ilumi-Setup-0.1.2-x64.exe", detail: "64-bit (.exe)" },
  { os: "windows", label: "Windows ARM", file: "Ilumi-Setup-0.1.2-arm64.exe", detail: "ARM (.exe)" },
  { os: "linux", label: "Linux", file: "Ilumi_0.1.2_amd64.deb", detail: "x64 (.deb)" },
  { os: "linux", label: "Linux ARM", file: "Ilumi_0.1.2_arm64.deb", detail: "ARM64 (.deb)" },
  { os: "linux", label: "Linux AppImage", file: "Ilumi-0.1.2-x86_64.AppImage", detail: "x64 (.AppImage)" },
  { os: "linux", label: "Linux AppImage ARM", file: "Ilumi-0.1.2-arm64.AppImage", detail: "ARM64 (.AppImage)" },
];

const primaryByOS: Record<OS, string> = {
  mac: "Ilumi-0.1.2-arm64.dmg",
  windows: "Ilumi-Setup-0.1.2-x64.exe",
  linux: "Ilumi_0.1.2_amd64.deb",
  unknown: "",
};
  ...
  return (
    <div className="hero-buttons">
      ...
      <div className="dl-meta">
        v0.1.2 · <a href={RELEASES}>All platforms</a>
      </div>
